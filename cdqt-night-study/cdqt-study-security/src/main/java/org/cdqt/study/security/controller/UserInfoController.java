package org.cdqt.study.security.controller;
...
import org.cdqt.study.security.entity.UserInfo.Login;
import org.cdqt.study.security.global.BaseGlobal;
import org.cdqt.study.security.service.iface.IUserInfoService;
...
public class UserInfoController {
	...
	@Authentication(authc = true)
	public ResultApi<?> logout(@RequestHeader(BaseGlobal.TOKEN_FLAG) String token) {
		/* 移除缓存 */
		redisCacheManager.removeSessionByToken(BaseGlobal.CACHE_WEB_USER, token);
